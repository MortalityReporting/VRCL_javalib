...
import edu.gatech.chai.VRCL.model.util.DecedentAgeUtil;

@ResourceDef(name = "Observation", profile = "http://hl7.org/fhir/us/VRCL/StructureDefinition/VRCL-decedent-age")
public class DecedentAge extends Observation {
	...
	public DecedentAge() {
		...
		// required fields and fixed values by VRCL IG http://hl7.org/fhir/us/VRCL/StructureDefinition-VRCL-decedent-age.html
