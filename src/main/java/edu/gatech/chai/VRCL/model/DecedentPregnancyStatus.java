...
import edu.gatech.chai.VRCL.model.util.DecedentPregnancyStatusUtil;

@ResourceDef(name = "Observation", profile = "http://hl7.org/fhir/us/VRCL/StructureDefinition/VRCL-decedent-pregnancy-status")
